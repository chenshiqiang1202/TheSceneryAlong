...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	public boolean onTouchEvent( MotionEvent event ) {
		if(mDisallowInterceptParent != null && getScale() > 1){
			if(event.getAction() == MotionEvent.ACTION_DOWN){
				mDisallowInterceptParent.requestDisallowInterceptTouchEvent(true);
			}else if(event.getAction() == MotionEvent.ACTION_UP){
				mDisallowInterceptParent.requestDisallowInterceptTouchEvent(false);
			}
		}
	...
	private ViewGroup mDisallowInterceptParent = null;
	public void setDisallowInterceptParent(ViewGroup mDisallowInterceptParent) {
